...
<div id="FilterFrame"><h2 class="FilterText"><i class="fas fa-filter"></i> Filteren </h2>
    <form>
        <div id="FilterOptions">
            <h5 class="FilterTopMargin"><i class="fas fa-search"></i> Zoeken</h5>
            <input type="text" name="search_string" id="search_string"
                   value="<?php print (isset($_GET['search_string'])) ? $_GET['search_string'] : ""; ?>"
                   class="form-submit">
            <h5 class="FilterTopMargin"><i class="fas fa-list-ol"></i> Aantal producten op pagina</h5>
            ...
            <h5 class="FilterTopMargin"><i class="fas fa-sort"></i> Sorteren</h5>
